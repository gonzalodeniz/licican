                ...
                "usr-003": [
                    {
                        ...
                        "detalle": "Alta inicial de la cuenta.",
                    }
                ],
                "usr-004": [
                    {
...
class _FakeCursor:
    ...
    def execute(self, sql, params=None):
        ...
        if normalized in {
            ...
            auth_service.AUTH_USER_RESET_LOGIN_STATE_SQL.strip(),
            auth_service.AUTH_USER_RECORD_FAILED_LOGIN_SQL.strip(),
            auth_service.AUTH_USER_RECORD_SUCCESSFUL_LOGIN_SQL.strip(),
        }:
            self.rows = []
            self.row = None
            return
