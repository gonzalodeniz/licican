...
- `make test` ejecuta 49 pruebas en verde.
...
- Aunque el changelog de `2026-03-27` menciona `PB-011`, el despliegue documentado aqui sigue sin consolidar snapshots `.atom`; si se publica la entrega actual, el catalogo seguira saliendo de `data/opportunities.json`.
