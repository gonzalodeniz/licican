...
La accion concreta recomendada en esta revision es convertir la Mejora 25 en limpieza real de los `AGENTS.md` de rol: mantener solo lo especifico de cada equipo, dejar las reglas compartidas en `agile-coach/acuerdos-operativos.md` y medir el avance con las metricas 15 y 16 para comprobar que la simplificacion reduce coste y no solo cambia la redaccion.
