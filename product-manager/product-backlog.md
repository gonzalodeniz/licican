...
- Fecha de corte funcional: 2026-03-28.
...
- `PB-012` deja de tratarse como `nuevo`: `qa-teams` la marco como `no validado` el 2026-03-28 por ausencia de rama remota y de handoff valido de `developer-teams`.
...
- A fecha 2026-03-29 no existen ramas tecnicas remotas abiertas; la restriccion operativa inmediata no es de saturacion de ramas sino de reentrega de `PB-012` y de visibilidad de deuda tecnica priorizable.
...
- `PB-012` queda en `no validado` y debe priorizarse como reentrega sobre la misma issue #12 antes de abrir nueva expansion de dato visible.
