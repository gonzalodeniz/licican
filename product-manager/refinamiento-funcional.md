...
- `T-002` ya quedo validado por `qa-teams` el 2026-03-30, pero sigue pendiente de integracion en `main`; no debe tratarse como cerrado hasta que `developer-teams` deje evidencia de merge y borrado de rama.
- `PB-014` y `PB-015` aparecen como nuevas piezas funcionales para escalado de consulta y gobierno de datos; deben planificarse una vez quede resuelta la integracion administrativa de `T-002`.
